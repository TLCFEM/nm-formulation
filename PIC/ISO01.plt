...
plot "ISO01.txt" u 1:2 w l lw 2 lc rgb "#e41a1c" notitle
unset ylabel
...
set label 1 at screen .6,.3 front "\\input{PIC/ISO01D}"
plot "ISO01.txt" u 1:3 with points pt 7 lc rgb "#377eb8" notitle
unset multiplot
set output