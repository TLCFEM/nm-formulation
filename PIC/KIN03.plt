...
plot "KIN03.txt" u 1:2 w l lw 2 lc rgb "#e41a1c" notitle
unset ylabel
...
set label 1 at screen .6,.25 front "\\input{PIC/KIN03D}"
plot "KIN03.txt" u 1:3 with points pt 7 lc rgb "#377eb8" notitle
unset multiplot
set output